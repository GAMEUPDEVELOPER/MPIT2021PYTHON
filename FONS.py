...
class Mygame(ar.Window):
    ...
    def setup(self):
        ar.set_background_color(ar.color.SAND)
        ...
        if stranica == 1:
            self.fon = ar.Sprite('ввех.png',0.7)
            self.fon.center_x = 620
            self.fon.center_y = 270
    ...
    def on_draw(self):
        ...
        if stranica == 2:
            ...
            ar.draw_text(f'счет:{self.count}',50,550,ar.color.BLACK,18)

            ar.draw_text(f'счет:{self.counttwo}',950,550,ar.color.BLACK,18)
            ...
            ar.draw_rectangle_filled(520,320,10,1040,ar.color.WHITE_SMOKE)

        if stranica == 1:
            self.fon.draw()

            ar.draw_text('СТАРТ',440,290,ar.color.RED, 100)
